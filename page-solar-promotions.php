...
<main class="solar-promotions">

    <?php get_template_part('includes/section', 'hero');?>

    <div class="container">
        <div class="row">
            <div class="solar-promotions__content col-12">

                <?php get_template_part("includes/section", "content"); ?>

            </div>
            <div class="solar-promotions__form-wrapper col-12 col-md-6">

                <h1>Submit an enquiry</h1>
                <p>Offers valid while stocks last, contact us today to make sure you don't miss out.</p>
